...
# ---------------------------------------------------------------------- #
#                       11a. Model prediction - TBE                      #
# ---------------------------------------------------------------------- #

# What is done within this script:

# For TBE, we generate continuous ensemble predictions for historical 
...
# vector species, Ixodes ricinus, as predictor rasters.
...
I_ricinus_r_past_preds_clim_landuse <- terra::rast("output_data/results/preprocessed_predictions/Ixodes_ricinus/I_ricinus_preds_clim_landuse_ens_1970_2019.tif") 
...
for (y in years) { # Start of the loop over the prediction years
  ...
  for (m in month) { # Start of the loop over all months of a year
    ...
    Species_data <- I_ricinus_r_past_preds_clim_landuse[[paste0(m,"/",y)]] # Occurrence probabilities of the vector species Ixodes ricinus
...
terra::writeRaster(r_past_preds_clim_landuse_ens, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_ens_bin, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_glm, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_gam, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_rf, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_brt, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_brt_1970_2019.tif", overwrite=T)
...
I_ricinus_r_past_preds_noclim_landuse <-  terra::rast("output_data/results/preprocessed_predictions/Ixodes_ricinus/I_ricinus_preds_noclim_landuse_ens_1970_2019.tif")
...
for (y in years) { # Start of the loop over the prediction years
  ...
  for (m in month) { # Start of the loop over all months of a year
    ...
    Species_data <- I_ricinus_r_past_preds_noclim_landuse[[paste0(m,"/",y)]] # Occurrence probabilities of the vector species Ixodes ricinus
...
# Save the raster outputs
terra::writeRaster(r_past_preds_noclim_landuse_ens, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_landuse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_ens_bin, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_landuse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_glm, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_landuse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_gam, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_landuse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_rf, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_landuse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_brt, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_landuse_brt_1970_2019.tif", overwrite=T)
...
I_ricinus_r_past_preds_clim_nolanduse <-  terra::rast("output_data/results/preprocessed_predictions/Ixodes_ricinus/I_ricinus_preds_clim_nolanduse_ens_1970_2019.tif")
...
for (y in years) { # Start of the loop over the prediction years
  ...
  for (m in month) { # Start of the loop over all months of a year
    ...
    # Load the environmental data for the specific year and month
    Climate_data <- terra::rast(paste0(datapath_env, "/Climate/processed_data/Climate_data_",m,"_",y,".tif")) # Climate data
    Species_data <- I_ricinus_r_past_preds_clim_nolanduse[[paste0(m,"/",y)]] # Occurrence probabilities of the vector species Ixodes ricinus
...
# Save the raster outputs
terra::writeRaster(r_past_preds_clim_nolanduse_ens, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_nolanduse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_ens_bin, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_nolanduse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_glm, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_nolanduse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_gam, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_nolanduse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_rf, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_nolanduse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_brt, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_nolanduse_brt_1970_2019.tif", overwrite=T)
...
I_ricinus_r_past_preds_noclim_nolanduse <-  terra::rast("output_data/results/preprocessed_predictions/Ixodes_ricinus/I_ricinus_preds_noclim_nolanduse_ens_1970_2019.tif")
...
for (y in years) { # Start of the loop over the prediction years
  ...
  for (m in month) { # Start of the loop over all months of a year
    ...
    # Load the environmental data for the specific year and month
    Climate_data <- terra::rast(paste0(datapath_env, "/CounterClim/processed_data/CounterClim_data_",m,"_",y,".tif")) # Climate data
    Species_data <- I_ricinus_r_past_preds_noclim_nolanduse[[paste0(m,"/",y)]] # Occurrence probabilities of the vector species Ixodes ricinus
...
# Save the raster outputs
terra::writeRaster(r_past_preds_noclim_nolanduse_ens, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_nolanduse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_ens_bin, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_nolanduse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_glm, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_nolanduse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_gam, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_nolanduse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_rf, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_nolanduse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_brt, filename = "output_data/results/preprocessed_predictions/TBE/TBE_preds_noclim_nolanduse_brt_1970_2019.tif", overwrite=T)
...
for (s in scenario) { # Start of the loop over the three different forcing scenarios
  ...
  for (l in clim_models) { # Start of the loop over all 5 climate models
    ...
    file_exists <- file.exists(paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_ens_2020_2059_",l,"_",s,".tif"))
    ...
    I_ricinus_r_fut_preds_clim_landuse <-  terra::rast(paste0("output_data/results/preprocessed_predictions/Ixodes_ricinus/I_ricinus_preds_clim_landuse_ens_2020_2059_",l,"_",s,".tif"))
    ...
    # Save the raster outputs
    terra::writeRaster(r_fut_preds_clim_landuse_ens, filename = paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_ens_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_ens_bin, filename = paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_ens_bin_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_glm, filename = paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_glm_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_gam, filename = paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_gam_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_rf, filename = paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_rf_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_brt, filename = paste0("output_data/results/preprocessed_predictions/TBE/TBE_preds_clim_landuse_brt_2020_2059_",l,"_",s,".tif"), overwrite=T)
