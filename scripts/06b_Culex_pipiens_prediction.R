...
# ---------------------------------------------------------------------- #
#                   06b. Model prediction - Culex pipiens                #
# ---------------------------------------------------------------------- #

# What is done within this script:

# For Culex pipiens, we generate continuous ensemble predictions for historical 
...
terra::writeRaster(r_past_preds_clim_landuse_ens, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_ens_bin, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_glm, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_gam, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_rf, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_landuse_brt, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_brt_1970_2019.tif", overwrite=T)
...
# Save the raster outputs
terra::writeRaster(r_past_preds_noclim_landuse_ens, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_landuse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_ens_bin, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_landuse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_glm, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_landuse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_gam, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_landuse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_rf, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_landuse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_landuse_brt, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_landuse_brt_1970_2019.tif", overwrite=T)
...
# Save the raster outputs
terra::writeRaster(r_past_preds_clim_nolanduse_ens, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_nolanduse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_ens_bin, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_nolanduse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_glm, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_nolanduse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_gam, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_nolanduse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_rf, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_nolanduse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_clim_nolanduse_brt, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_nolanduse_brt_1970_2019.tif", overwrite=T)
...
# Save the raster outputs
terra::writeRaster(r_past_preds_noclim_nolanduse_ens, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_nolanduse_ens_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_ens_bin, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_nolanduse_ens_bin_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_glm, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_nolanduse_glm_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_gam, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_nolanduse_gam_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_rf, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_nolanduse_rf_1970_2019.tif", overwrite=T)
terra::writeRaster(r_past_preds_noclim_nolanduse_brt, filename = "output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_noclim_nolanduse_brt_1970_2019.tif", overwrite=T)
...
for (s in scenario) { # Start of the loop over the three different forcing scenarios
  ...
  for (l in clim_models) { # Start of the loop over the different climate models
    ...
    file_exists <- file.exists(paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_ens_2020_2059_",l,"_",s,".tif"))
    ...
    # Save the raster outputs
    terra::writeRaster(r_fut_preds_clim_landuse_ens, filename = paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_ens_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_ens_bin, filename = paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_ens_bin_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_glm, filename = paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_glm_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_gam, filename = paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_gam_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_rf, filename = paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_rf_2020_2059_",l,"_",s,".tif"), overwrite=T)
    terra::writeRaster(r_fut_preds_clim_landuse_brt, filename = paste0("output_data/results/preprocessed_predictions/Culex_pipiens/C_pipiens_preds_clim_landuse_brt_2020_2059_",l,"_",s,".tif"), overwrite=T)
